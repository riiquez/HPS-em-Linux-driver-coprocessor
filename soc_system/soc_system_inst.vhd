	component soc_system is
		port (
			...
			ctrl_external_connection_export       : out   std_logic_vector(2 downto 0)                      -- export
		);
	...
	u0 : component soc_system
		port map (
			...
			ctrl_external_connection_export       => CONNECTED_TO_ctrl_external_connection_export        --     ctrl_external_connection.export
		);
